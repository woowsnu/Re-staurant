...
const REVIEWS = [
  ...
  },
  {
    ...
    user: {
      ...
      name: 'My 동석',
      profileImg:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS8bzNsK42l6AuLThyLkh8YjGdtwTPFOpnwrg&usqp=CAU',
    },
    comment: '맛없어요',
    review: '다신 안가용',
    date: '2022-08-13',
...
const RestaurantDetail = () => {
  ...
  const fetchRestaurantData = async () => {
    try {
      ...
      // 전체로 묶인 문자열 분리 (다른 방법 있을지 확인)
      let menuDataString = response.data.menuList
        .replaceAll('{m', '{"m')
        .replaceAll(':', '":"')
        .replaceAll(', m', '","m')
        .replaceAll('원}', '원"}')
